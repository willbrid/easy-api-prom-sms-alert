...
func setConfigDefaults(v *viper.Viper) {
	...
	v.SetDefault("easy_api_prom_sms_alert.provider.parameters.from.param_method", httpparam.PostType)
	...
	v.SetDefault("easy_api_prom_sms_alert.provider.parameters.to.param_method", httpparam.PostType)
	...
	v.SetDefault("easy_api_prom_sms_alert.provider.parameters.message.param_method", httpparam.PostType)
